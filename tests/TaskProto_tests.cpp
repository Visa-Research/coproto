    ...
    namespace tests
    {
        ...
        void task_asyncProtocol_Test()
        {
            ...
            auto proto = [n, print, rep](Socket& s, bool party, macoro::thread_pool& ex) -> task<void> {
                ...
                auto fus = std::vector<macoro::eager_task<int>>{};
                auto i = u64{};
                ...
                if (party)
                {
                    ...
                    fus.emplace_back(task_echoServer(s.fork(), n, 5, rep, name, print) | macoro::start_on(ex));
                    //#ifdef MULTI
                    fus.emplace_back(task_echoServer(s.fork(), n + 2, 6, rep, name, print) | macoro::start_on(ex));
                    fus.emplace_back(task_echoServer(s.fork(), n, 7, rep, name, print) | macoro::start_on(ex));
                    fus.emplace_back(task_echoServer(s.fork(), n + 7, 8, rep, name, print) | macoro::start_on(ex));
                    fus.emplace_back(task_echoServer(s.fork(), n, 9, rep, name, print) | macoro::start_on(ex));
                    //#endif
                ...
                else
                {
                    ...
                    fus.emplace_back(task_echoClient(s.fork(), n, 5, rep, name, print) | macoro::start_on(ex));
                    //#ifdef MULTI
                    fus.emplace_back(task_echoClient(s.fork(), n + 2, 6, rep, name, print) | macoro::start_on(ex));
                    fus.emplace_back(task_echoClient(s.fork(), n, 7, rep, name, print) | macoro::start_on(ex));
                    fus.emplace_back(task_echoClient(s.fork(), n + 7, 8, rep, name, print) | macoro::start_on(ex));
                    fus.emplace_back(task_echoClient(s.fork(), n, 9, rep, name, print) | macoro::start_on(ex));
                    //#endif
